...
function theme_enqueue_styles() {
    ...
    wp_enqueue_style ('font-space-mono-style', 'https://fonts.googleapis.com/css2?family=Space+Mono:ital,wght@0,400;0,700;1,400;1,700&display=swap');
    wp_enqueue_style ('font-poppins-style', 'https://fonts.googleapis.com/css2?family=Poppins:wght@300&display=swap');
}
